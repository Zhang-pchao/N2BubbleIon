...
Dfile = open(os.path.join(save_path, "Density_step{0}_dr{1}.txt".format(trj_step,delta_r)), 'w+')
...
def density_fig(bin_centers,
    ...
    fig.show()
    fig.savefig(os.path.join(save_path, "Density_step{0}_dr{1}.png".format(trj_step,delta_r)), dpi=600, bbox_inches='tight')    
